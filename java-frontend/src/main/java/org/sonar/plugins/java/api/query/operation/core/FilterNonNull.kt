...
fun <INIT, CUR> SingleSelector<INIT, CUR?>.filterNonNull(): OptionalSelector<INIT, CUR> {
  return apply(FilterNonNullOperation())
}

fun <INIT, CUR> OptionalSelector<INIT, CUR?>.filterNonNull(): OptionalSelector<INIT, CUR> {
  return apply(FilterNonNullOperation())
}

fun <INIT, CUR> ManySelector<INIT, CUR?>.filterNonNull(): ManySelector<INIT, CUR> {
  return apply(FilterNonNullOperation())
}
