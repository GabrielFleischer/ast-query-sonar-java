...
fun <INIT, LEFT, RIGHT, OUT> SingleSelector<INIT, LEFT>.combine(
  other: SingleSelector<*, RIGHT>,
  combiner: IdentifiedFunction<(LEFT, RIGHT) -> OUT>,
): SingleSelector<INIT, OUT> {
  return apply(CombineOperation(other.toSingle(), combiner))
}

fun <INIT, LEFT, RIGHT, OUT> OptionalSelector<INIT, LEFT>.combine(
  other: SingleSelector<*, RIGHT>,
  combiner: IdentifiedFunction<(LEFT, RIGHT) -> OUT>,
...
fun <INIT, LEFT, RIGHT, OUT> ManySelector<INIT, LEFT>.combine(
  other: SingleSelector<*, RIGHT>,
  combiner: IdentifiedFunction<(LEFT, RIGHT) -> OUT>,
